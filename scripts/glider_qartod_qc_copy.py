...
#def main(args):
def main(deployments, mode, cdm_data_type, loglevel, dataset_type, test):
    status = 0
...
if __name__ == '__main__':
    deploy = 'ru30-20210226T1647'  # maracoos_02-20210716T1814 ru34-20200729T1430 ru33-20201014T1746 ru33-20200715T1558  ru32-20190102T1317 ru30-20210503T1929
    mode = 'rt'
    d = 'profile'
    ll = 'info'
    level = 'sci'
